...
Упрощенный режим подразумевает, что у игрока есть право ошибиться 3 раза. В обычном режиме права на ошибку нет.
...
- Если карточки не совпадают ⇒ списывается одна попытка. Если попытки кончились, игра заканчивается
